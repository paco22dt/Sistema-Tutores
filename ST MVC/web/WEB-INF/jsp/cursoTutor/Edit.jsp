...
<f:view>
    <html>
        <head>
            ...
            <title>Editing CursoTutor</title>
        ...
        <body>
            ...
            <h:form>
                ...
                <br />
                <h:commandLink action="#{cursoTutor.edit}" value="Save">
                ...
                <br />
                <br />
                <h:commandLink action="#{cursoTutor.detailSetup}" value="Show" immediate="true">
                    <f:param name="jsfcrud.currentCursoTutor" value="#{jsfcrud_class['View.jsf.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][cursoTutor.cursoTutor][cursoTutor.converter].jsfcrud_invoke}"/>
                </h:commandLink>
                <br />
